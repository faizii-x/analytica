  ...
  return (
    <section className="relative bg-[#f8f9fb] min-h-screen flex items-center justify-center px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        <h1
          className="text-5xl sm:text-6xl lg:text-7xl font-extrabold leading-tight tracking-tight text-gray-900 mb-8"
          data-aos="fade-up"
          data-aos-delay="100"
        >
        ...
        <p
          ...
          data-aos-delay="300"
        >
          At <strong className="text-blue-600">InsightIQ</strong>, we help
          modern teams turn complex data into actionable decisions using
          AI-powered analytics, automation, and meaningful visuals.
        </p>
